...
'''
with open('./model/LightLog/data/hdfs_semantic_vec.json') as f:
    # Step1-1 open file
...
def TCN(train_x,train_y,valid_x,valid_y):
    ...
    #训练模型
    model.fit(train_x,train_y,batch_size=64,nb_epoch=10,verbose=2,validation_data=(valid_x,valid_y))
    model_path = './model/LightLog/model/E_TCN_GAP.h5'
    model.save(model_path)

# Path
train_path = './model/LightLog/data/log_train.csv'
